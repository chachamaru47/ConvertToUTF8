...
namespace AkSystem
{
    internal class EncodeConverter
    {
        ...
        /// <param name="extList">対象拡張子リスト</param>
        /// <returns>変換したら true</returns>
        public static bool ConvertToUTF8(string path, string[]? extList = null)
        {
            ...
            if (enc != null)
            {
                ...
                File.WriteAllText(path + "utf8.txt", contents, newEnc);
                return true;
            }
